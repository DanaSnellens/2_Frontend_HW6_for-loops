...
////////////// V R A A G /////////////
// Klopt het dat je geen < of > mag gebruiken in de cases van switch statements? Ik kreeg hier foutmeldingen van.
// Ik heb gegoogled en verschillende dingen geprobeerd, maar uiteindelijk toch een if statement gebruikt,
// omdat ik het niet voor elkaar kreeg in een switch.
...
for (let i = 0; i < scores.length; i++) {
    if (scores[i].score < 60) {
        ...
        scores[i].grade ="You're too good"
    }
}
...
for (let i = 0; i < NOVIEmployees.length; i++) {
    NOVIEmployees[i].email = NOVIEmployees[i].firstName.toLocaleLowerCase() + "." + NOVIEmployees[i].lastName.toLocaleLowerCase() + "@novi.nl";
}
console.log(NOVIEmployees)
// ==========================================
// Opdracht 3
...
for (let i = 0; i < students.length; i++) {
    switch (students[i].zipCode){
        ...
        case '3583':
            ...
            break;
        default: students[i].neighborhood = 'Unknown';
    }
}
